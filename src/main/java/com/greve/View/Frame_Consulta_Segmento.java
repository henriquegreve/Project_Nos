 ...
 * @author Paulo-PC
 */
public class Frame_Consulta_Segmento extends javax.swing.JFrame {

    /**
     * Creates new form Frame_Consulta_Segmento
     */
    public Frame_Consulta_Segmento() {
        initComponents();
    }
    ...
    private void btnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOKActionPerformed
        ...
        Controller.preencheTableSegmento(jTable1, txtDescricao.getText(), chbAtivo.isSelected());
    ...
    private void chamaCadastro(int id) {
        JFrame seg = new Frame_Cad_Segmento(id);
        seg.setVisible(true);
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frame_Consulta_Segmento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>

        /* Create and display the form */
        java.awt.EventQueue.invokeLater(() -> new Frame_Consulta_Segmento().setVisible(true));
    }
