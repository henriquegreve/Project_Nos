 ...
 * @author Paulo-PC
 */
public class Frame_Consulta_User extends javax.swing.JFrame {

    /**
     * Creates new form Frame_User_Consulta
     */
    public Frame_Consulta_User(int nivel) {
    ...
    private void initComponents() {
        ...
        cbbLevel.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Visitante", "Usuario", "Administrador", "Bloquado" }));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(cbbLevel, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
    ...
    private void btnGoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGoActionPerformed
        ...
        Controller.preencheTableUser(jTable1, txtLogin.getText(), cbbLevel.getSelectedIndex()+1);
    }//GEN-LAST:event_btnGoActionPerformed

    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        // TODO add your handling code here:
        if(!txtLogin.getText().trim().equals("") || cbbLevel.getSelectedIndex() != -1 ) {
            txtLogin.setText("");
            cbbLevel.setSelectedIndex(-1);
        } else {
    ...
    private void chamaCadastro(int id){
        JFrame cad = new Frame_Cad_User(id);
        cad.setVisible(true);
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frame_Consulta_User.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>

        /* Create and display the form */
        java.awt.EventQueue.invokeLater(() -> new Frame_Consulta_User(0).setVisible(true));
    }
