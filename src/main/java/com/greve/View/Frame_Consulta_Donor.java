 ...
 * @author Paulo-PC
 */
public class Frame_Consulta_Donor extends javax.swing.JFrame {

    /**
     * Creates new form Frame_Donor_Consulta
     */
    public Frame_Consulta_Donor(int nivel) {
        initComponents();
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txtCPF_CNPJ, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
    ...
    private void btnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOKActionPerformed
        ...
        Controller.preencheTableDonor(jTable1, txtNome.getText(), txtSobrenome.getText(), txtCPF_CNPJ.getText());
    ...
    private void chamaCadastro(int id) {
        JFrame cad = new Frame_Cad_Donor(id);
        cad.setVisible(true);
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frame_Consulta_Donor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Frame_Consulta_Donor(0).setVisible(true);
        });
    }
